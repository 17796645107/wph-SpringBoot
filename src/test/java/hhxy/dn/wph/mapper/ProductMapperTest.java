...
public class ProductMapperTest extends TestTemplate {
    ...
    public static final Logger LOGGER = LoggerFactory.getLogger(ProductMapperTest.class);
    ...
    public void listProductByArrtibute() {
        ...
        List<Integer> intList = productMapper.listProductIdByArrtibute(productAttributeRelation);
