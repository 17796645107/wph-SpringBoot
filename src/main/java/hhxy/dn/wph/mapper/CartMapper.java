...
public interface CartMapper {
    ...
    final String CoodCart_field = " cart_id,user_no,product_id,product_number,product_color,product_size,state,created,updated ";
    ...
    //根据用户ID查询购物车记录数
    @Select("select COUNT(cart_id) FROM"+ CART +"where user_no = #{userNo}  and state = 1")
